--LAST POSITIONS FILTERED BY ID and CREATED_DATE

WITH LAST_POSITIONS AS (
    SELECT id, MAX(spacetrack.creation_date) AS max_date FROM starlink_test WHERE id = '60106f1b0c72a20006004ba4' AND spacetrack.creation_date = '2021-01-25T23:06:08' GROUP BY id
)
